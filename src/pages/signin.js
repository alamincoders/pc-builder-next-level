      ...
      <div className="border-red-500 bg-gray-200 min-h-screen flex items-center justify-center">
        <div className="bg-gray-100 p-5 flex rounded-2xl shadow-lg max-w-3xl">
          <div className="md:w-1/2 px-5">
            ...
            <p className="text-sm mt-4 text-[#002D74]">If you have an account, please signin</p>
            ...
            <button
              onClick={() =>
                signIn("google", {
                  callbackUrl: "https://pc-builder-next-level.vercel.app/",
                })
              }
            ...
            <div className="text-sm flex justify-between items-center mt-3">
              ...
              <Link href="/signup">
                <button className="py-2 px-5 ml-3 bg-white border rounded-xl hover:scale-110 duration-300 border-blue-400">Sign Up</button>
              </Link>
            </div>
          </div>
