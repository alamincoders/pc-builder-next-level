...
const ErrorPage = () => {
  return (
    <>
      <section className="relative z-10 bg-error h-screen flex items-center justify-center">
          ...
          <div className="flex -mx-4">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[400px] text-center">
                ...
                <p className="mb-8 text-lg text-white">The page you are looking for it maybe deleted</p>
                <Link
                  href="/"
